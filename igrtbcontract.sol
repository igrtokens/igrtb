...
contract igotruggedonbase is ERC20, Ownable {
    ...
    constructor() ERC20("tokenname", "Symbol") {
        ...
        marketingWallet = address(0x0c3377D347084D0E1866DB5a6576d2bA705137b7);
        devWallet = address(0x420D6dD2D192Ce4c9EF874d6b138338fc41c6e0C);
